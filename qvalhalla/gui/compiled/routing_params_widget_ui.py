...
# Form implementation generated from reading ui file 'qvalhalla/resources/ui/routing_params_widget.ui'
#
...
class Ui_RoutingParams(object):
    def setupUi(self, RoutingParams):
        ...
        self.ui_extra_box = QgsCollapsibleGroupBox(RoutingParams)
        ...
        self.ui_time_box = QgsCollapsibleGroupBox(RoutingParams)
        ...
        self.ui_date_time_value = QgsDateTimeEdit(self.ui_time_box)
        ...
        self.exclude_geometries_box = QgsCollapsibleGroupBox(RoutingParams)
        ...
        self.exclude_locations = QgsMapLayerComboBox(self.exclude_geometries_box)
        ...
        self.exclude_polygons = QgsMapLayerComboBox(self.exclude_geometries_box)
        ...
        self.ui_metric_box = QgsCollapsibleGroupBox(RoutingParams)
