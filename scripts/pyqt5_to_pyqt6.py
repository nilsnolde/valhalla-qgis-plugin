...
from PyQt6 import (Qsci, QtCore, QtGui, QtNetwork, QtPrintSupport,
                   QtQuickWidgets, QtSql, QtSvg, QtTest, QtWidgets, QtXml)
...
from tokenize_rt import (Offset, Token, reversed_enumerate, src_to_tokens,
                         tokens_to_src)
