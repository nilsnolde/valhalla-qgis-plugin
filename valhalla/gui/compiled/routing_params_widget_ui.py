...
class Ui_RoutingParams(object):
    def setupUi(self, RoutingParams):
        ...
        self.ui_reset_settings = QtWidgets.QToolButton(parent=RoutingParams)
        ...
        self.ui_extra_box = gui.QgsCollapsibleGroupBox(parent=RoutingParams)
        ...
        self.ui_extra_json = QtWidgets.QTextEdit(parent=self.ui_extra_box)
        ...
        self.ui_time_box = gui.QgsCollapsibleGroupBox(parent=RoutingParams)
        ...
        self.label = QtWidgets.QLabel(parent=self.ui_time_box)
        self.label.setObjectName("label")
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label)
        self.ui_date_time_value = gui.QgsDateTimeEdit(parent=self.ui_time_box)
        self.ui_date_time_value.setAllowNull(False)
        self.ui_date_time_value.setObjectName("ui_date_time_value")
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.ItemRole.FieldRole, self.ui_date_time_value)
        self.label_2 = QtWidgets.QLabel(parent=self.ui_time_box)
        self.label_2.setObjectName("label_2")
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label_2)
        self.horizontalLayout_4 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_4.setObjectName("horizontalLayout_4")
        self.ui_time_current = QtWidgets.QRadioButton(parent=self.ui_time_box)
        ...
        self.ui_time_depart = QtWidgets.QRadioButton(parent=self.ui_time_box)
        self.ui_time_depart.setObjectName("ui_time_depart")
        self.horizontalLayout_4.addWidget(self.ui_time_depart)
        self.ui_time_arrive = QtWidgets.QRadioButton(parent=self.ui_time_box)
        ...
        self.exclude_geometries_box = gui.QgsCollapsibleGroupBox(parent=RoutingParams)
        ...
        self.exclude_locations_label = QtWidgets.QLabel(parent=self.exclude_geometries_box)
        self.exclude_locations_label.setOpenExternalLinks(True)
        self.exclude_locations_label.setObjectName("exclude_locations_label")
        self.formLayout_5.setWidget(0, QtWidgets.QFormLayout.ItemRole.LabelRole, self.exclude_locations_label)
        self.exclude_locations = gui.QgsMapLayerComboBox(parent=self.exclude_geometries_box)
        self.exclude_locations.setAllowEmptyLayer(True)
        self.exclude_locations.setObjectName("exclude_locations")
        self.formLayout_5.setWidget(0, QtWidgets.QFormLayout.ItemRole.FieldRole, self.exclude_locations)
        self.exclude_polygons_label = QtWidgets.QLabel(parent=self.exclude_geometries_box)
        self.exclude_polygons_label.setOpenExternalLinks(True)
        self.exclude_polygons_label.setObjectName("exclude_polygons_label")
        self.formLayout_5.setWidget(1, QtWidgets.QFormLayout.ItemRole.LabelRole, self.exclude_polygons_label)
        self.exclude_polygons = gui.QgsMapLayerComboBox(parent=self.exclude_geometries_box)
        self.exclude_polygons.setAllowEmptyLayer(True)
        self.exclude_polygons.setObjectName("exclude_polygons")
        self.formLayout_5.setWidget(1, QtWidgets.QFormLayout.ItemRole.FieldRole, self.exclude_polygons)
        self.verticalLayout.addWidget(self.exclude_geometries_box)
        self.ui_metric_box = gui.QgsCollapsibleGroupBox(parent=RoutingParams)
        ...
        self.ui_metric_fastest = QtWidgets.QRadioButton(parent=self.ui_metric_box)
        ...
        self.ui_metric_shortest = QtWidgets.QRadioButton(parent=self.ui_metric_box)
        ...
        self.ui_settings_stacked = QtWidgets.QStackedWidget(parent=RoutingParams)
