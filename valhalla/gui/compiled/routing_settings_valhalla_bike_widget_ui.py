...
class Ui_settings_valhalla_bike(object):
    def setupUi(self, settings_valhalla_bike):
        ...
        self.penalties = gui.QgsCollapsibleGroupBox(parent=settings_valhalla_bike)
        ...
        self.maneuver_penalty_label = QtWidgets.QLabel(parent=self.penalties)
        self.maneuver_penalty_label.setOpenExternalLinks(True)
        self.maneuver_penalty_label.setObjectName("maneuver_penalty_label")
        self.penalties_column_1.setWidget(0, QtWidgets.QFormLayout.ItemRole.LabelRole, self.maneuver_penalty_label)
        self.maneuver_penalty = gui.QgsSpinBox(parent=self.penalties)
        ...
        self.penalties_column_1.setWidget(0, QtWidgets.QFormLayout.ItemRole.FieldRole, self.maneuver_penalty)
        self.gate_penalty_label = QtWidgets.QLabel(parent=self.penalties)
        self.gate_penalty_label.setOpenExternalLinks(True)
        self.gate_penalty_label.setObjectName("gate_penalty_label")
        self.penalties_column_1.setWidget(1, QtWidgets.QFormLayout.ItemRole.LabelRole, self.gate_penalty_label)
        self.gate_penalty = gui.QgsSpinBox(parent=self.penalties)
        self.gate_penalty.setMaximum(43200)
        self.gate_penalty.setProperty("value", 300)
        self.gate_penalty.setObjectName("gate_penalty")
        self.penalties_column_1.setWidget(1, QtWidgets.QFormLayout.ItemRole.FieldRole, self.gate_penalty)
        ...
        self.service_penalty_label = QtWidgets.QLabel(parent=self.penalties)
        self.service_penalty_label.setOpenExternalLinks(True)
        self.service_penalty_label.setObjectName("service_penalty_label")
        self.penalties_column_2.setWidget(0, QtWidgets.QFormLayout.ItemRole.LabelRole, self.service_penalty_label)
        self.service_penalty = gui.QgsSpinBox(parent=self.penalties)
        ...
        self.penalties_column_2.setWidget(0, QtWidgets.QFormLayout.ItemRole.FieldRole, self.service_penalty)
        self.country_crossing_penalty_label = QtWidgets.QLabel(parent=self.penalties)
        ...
        self.penalties_column_2.setWidget(1, QtWidgets.QFormLayout.ItemRole.LabelRole, self.country_crossing_penalty_label)
        self.country_crossing_penalty = gui.QgsSpinBox(parent=self.penalties)
        self.country_crossing_penalty.setMaximum(43200)
        self.country_crossing_penalty.setObjectName("country_crossing_penalty")
        self.penalties_column_2.setWidget(1, QtWidgets.QFormLayout.ItemRole.FieldRole, self.country_crossing_penalty)
        self.horizontalLayout_8.addLayout(self.penalties_column_2)
        self.verticalLayout.addWidget(self.penalties)
        self.favor_types = gui.QgsCollapsibleGroupBox(parent=settings_valhalla_bike)
        ...
        self.use_roads_label = QtWidgets.QLabel(parent=self.favor_types)
        self.use_roads_label.setObjectName("use_roads_label")
        self.formLayout_5.setWidget(0, QtWidgets.QFormLayout.ItemRole.LabelRole, self.use_roads_label)
        self.use_hills_label = QtWidgets.QLabel(parent=self.favor_types)
        self.use_hills_label.setObjectName("use_hills_label")
        self.formLayout_5.setWidget(1, QtWidgets.QFormLayout.ItemRole.LabelRole, self.use_hills_label)
        self.use_roads = gui.QgsDoubleSpinBox(parent=self.favor_types)
        ...
        self.formLayout_5.setWidget(0, QtWidgets.QFormLayout.ItemRole.FieldRole, self.use_roads)
        self.use_hills = gui.QgsDoubleSpinBox(parent=self.favor_types)
        ...
        self.formLayout_5.setWidget(1, QtWidgets.QFormLayout.ItemRole.FieldRole, self.use_hills)
        self.avoid_bad_surfaces = gui.QgsDoubleSpinBox(parent=self.favor_types)
        ...
        self.formLayout_5.setWidget(2, QtWidgets.QFormLayout.ItemRole.FieldRole, self.avoid_bad_surfaces)
        self.avoid_bad_surfaces_label = QtWidgets.QLabel(parent=self.favor_types)
        self.avoid_bad_surfaces_label.setObjectName("avoid_bad_surfaces_label")
        self.formLayout_5.setWidget(2, QtWidgets.QFormLayout.ItemRole.LabelRole, self.avoid_bad_surfaces_label)
        self.horizontalLayout_7.addLayout(self.formLayout_5)
        self.formLayout_6 = QtWidgets.QFormLayout()
        self.formLayout_6.setObjectName("formLayout_6")
        self.use_living_streets = gui.QgsDoubleSpinBox(parent=self.favor_types)
        ...
        self.formLayout_6.setWidget(1, QtWidgets.QFormLayout.ItemRole.FieldRole, self.use_living_streets)
        self.use_ferry = gui.QgsDoubleSpinBox(parent=self.favor_types)
        ...
        self.formLayout_6.setWidget(0, QtWidgets.QFormLayout.ItemRole.FieldRole, self.use_ferry)
        self.use_ferry_label = QtWidgets.QLabel(parent=self.favor_types)
        self.use_ferry_label.setObjectName("use_ferry_label")
        self.formLayout_6.setWidget(0, QtWidgets.QFormLayout.ItemRole.LabelRole, self.use_ferry_label)
        self.use_living_streets_label = QtWidgets.QLabel(parent=self.favor_types)
        self.use_living_streets_label.setObjectName("use_living_streets_label")
        self.formLayout_6.setWidget(1, QtWidgets.QFormLayout.ItemRole.LabelRole, self.use_living_streets_label)
        self.horizontalLayout_7.addLayout(self.formLayout_6)
        self.verticalLayout.addWidget(self.favor_types)
        self.additional_parameters_box = gui.QgsCollapsibleGroupBox(parent=settings_valhalla_bike)
        ...
        self.bicycle_type_label = QtWidgets.QLabel(parent=self.additional_parameters_box)
        self.bicycle_type_label.setObjectName("bicycle_type_label")
        self.formLayout_4.setWidget(0, QtWidgets.QFormLayout.ItemRole.LabelRole, self.bicycle_type_label)
        self.bicycle_type = QtWidgets.QComboBox(parent=self.additional_parameters_box)
        self.bicycle_type.setObjectName("bicycle_type")
        self.bicycle_type.addItem("")
        self.bicycle_type.addItem("")
        self.bicycle_type.addItem("")
        self.bicycle_type.addItem("")
        self.formLayout_4.setWidget(0, QtWidgets.QFormLayout.ItemRole.FieldRole, self.bicycle_type)
        self.cycling_speed_label = QtWidgets.QLabel(parent=self.additional_parameters_box)
        self.cycling_speed_label.setObjectName("cycling_speed_label")
        self.formLayout_4.setWidget(1, QtWidgets.QFormLayout.ItemRole.LabelRole, self.cycling_speed_label)
        self.cycling_speed = gui.QgsSpinBox(parent=self.additional_parameters_box)
        self.cycling_speed.setObjectName("cycling_speed")
        self.formLayout_4.setWidget(1, QtWidgets.QFormLayout.ItemRole.FieldRole, self.cycling_speed)
