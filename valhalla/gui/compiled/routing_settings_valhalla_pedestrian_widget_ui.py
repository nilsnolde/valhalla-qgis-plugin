...
class Ui_settings_valhalla_pedestrian(object):
    def setupUi(self, settings_valhalla_pedestrian):
        ...
        self.penalties_box = gui.QgsCollapsibleGroupBox(parent=settings_valhalla_pedestrian)
        ...
        self.step_penalty_label = QtWidgets.QLabel(parent=self.penalties_box)
        self.step_penalty_label.setOpenExternalLinks(True)
        self.step_penalty_label.setObjectName("step_penalty_label")
        self.formLayout_4.setWidget(0, QtWidgets.QFormLayout.ItemRole.LabelRole, self.step_penalty_label)
        self.step_penalty = gui.QgsSpinBox(parent=self.penalties_box)
        self.step_penalty.setMaximum(43200)
        self.step_penalty.setObjectName("step_penalty")
        self.formLayout_4.setWidget(0, QtWidgets.QFormLayout.ItemRole.FieldRole, self.step_penalty)
        ...
        self.formLayout_4.setWidget(1, QtWidgets.QFormLayout.ItemRole.LabelRole, self.service_penalty_label)
        ...
        self.formLayout_4.setWidget(1, QtWidgets.QFormLayout.ItemRole.FieldRole, self.service_penalty)
        self.verticalLayout.addWidget(self.penalties_box)
        self.addtional_params_box = gui.QgsCollapsibleGroupBox(parent=settings_valhalla_pedestrian)
        ...
        self.walking_speed_label = QtWidgets.QLabel(parent=self.addtional_params_box)
        self.walking_speed_label.setOpenExternalLinks(True)
        self.walking_speed_label.setObjectName("walking_speed_label")
        self.additional_params_column_1.setWidget(0, QtWidgets.QFormLayout.ItemRole.LabelRole, self.walking_speed_label)
        self.walking_speed = gui.QgsDoubleSpinBox(parent=self.addtional_params_box)
        ...
        self.additional_params_column_1.setWidget(0, QtWidgets.QFormLayout.ItemRole.FieldRole, self.walking_speed)
        self.walkway_factor_label = QtWidgets.QLabel(parent=self.addtional_params_box)
        self.walkway_factor_label.setOpenExternalLinks(True)
        self.walkway_factor_label.setObjectName("walkway_factor_label")
        self.additional_params_column_1.setWidget(1, QtWidgets.QFormLayout.ItemRole.LabelRole, self.walkway_factor_label)
        self.walkway_factor = gui.QgsDoubleSpinBox(parent=self.addtional_params_box)
        ...
        self.additional_params_column_1.setWidget(1, QtWidgets.QFormLayout.ItemRole.FieldRole, self.walkway_factor)
        ...
        self.max_hiking_difficulty = gui.QgsSpinBox(parent=self.addtional_params_box)
        ...
        self.additional_params_column_1.setWidget(3, QtWidgets.QFormLayout.ItemRole.FieldRole, self.max_hiking_difficulty)
        self.max_hiking_difficulty_label = QtWidgets.QLabel(parent=self.addtional_params_box)
        self.max_hiking_difficulty_label.setObjectName("max_hiking_difficulty_label")
        self.additional_params_column_1.setWidget(3, QtWidgets.QFormLayout.ItemRole.LabelRole, self.max_hiking_difficulty_label)
        ...
        self.alley_factor_label = QtWidgets.QLabel(parent=self.addtional_params_box)
        self.alley_factor_label.setOpenExternalLinks(True)
        self.alley_factor_label.setObjectName("alley_factor_label")
        self.additional_params_column_2.setWidget(1, QtWidgets.QFormLayout.ItemRole.LabelRole, self.alley_factor_label)
        self.driveway_factor_label = QtWidgets.QLabel(parent=self.addtional_params_box)
        self.driveway_factor_label.setOpenExternalLinks(True)
        self.driveway_factor_label.setObjectName("driveway_factor_label")
        self.additional_params_column_2.setWidget(2, QtWidgets.QFormLayout.ItemRole.LabelRole, self.driveway_factor_label)
        self.sidewalk_factor_label = QtWidgets.QLabel(parent=self.addtional_params_box)
        self.sidewalk_factor_label.setOpenExternalLinks(True)
        self.sidewalk_factor_label.setObjectName("sidewalk_factor_label")
        self.additional_params_column_2.setWidget(0, QtWidgets.QFormLayout.ItemRole.LabelRole, self.sidewalk_factor_label)
        self.sidewalk_factor = gui.QgsDoubleSpinBox(parent=self.addtional_params_box)
        ...
        self.additional_params_column_2.setWidget(0, QtWidgets.QFormLayout.ItemRole.FieldRole, self.sidewalk_factor)
        self.alley_factor = gui.QgsDoubleSpinBox(parent=self.addtional_params_box)
        ...
        self.additional_params_column_2.setWidget(1, QtWidgets.QFormLayout.ItemRole.FieldRole, self.alley_factor)
        self.driveway_factor = gui.QgsDoubleSpinBox(parent=self.addtional_params_box)
        ...
        self.additional_params_column_2.setWidget(2, QtWidgets.QFormLayout.ItemRole.FieldRole, self.driveway_factor)
        ...
        self.favor_types_box = gui.QgsCollapsibleGroupBox(parent=settings_valhalla_pedestrian)
        ...
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.ItemRole.LabelRole, self.use_ferry_label)
        ...
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.ItemRole.FieldRole, self.use_ferry)
        self.use_hills_label = QtWidgets.QLabel(parent=self.favor_types_box)
        self.use_hills_label.setOpenExternalLinks(True)
        self.use_hills_label.setObjectName("use_hills_label")
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.ItemRole.LabelRole, self.use_hills_label)
        self.use_hills = gui.QgsDoubleSpinBox(parent=self.favor_types_box)
        ...
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.ItemRole.FieldRole, self.use_hills)
        ...
        self.formLayout_2.setWidget(0, QtWidgets.QFormLayout.ItemRole.LabelRole, self.use_living_streets_label)
        ...
        self.formLayout_2.setWidget(1, QtWidgets.QFormLayout.ItemRole.LabelRole, self.use_tracks_label)
        ...
        self.formLayout_2.setWidget(0, QtWidgets.QFormLayout.ItemRole.FieldRole, self.use_living_streets)
        ...
        self.formLayout_2.setWidget(1, QtWidgets.QFormLayout.ItemRole.FieldRole, self.use_tracks)
